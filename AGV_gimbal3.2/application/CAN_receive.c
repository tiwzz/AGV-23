		...
		switch (rx_header.StdId)
    {
				...
				case CAN_PIT_MOTOR_ID:
        {
            ...
            break;
				...
				case CAN_CHASSIS_TO_GIMBAL:
				{
				  gimbal_control.cap_capvot = (fp32)((int16_t)(((rx_data[0])<<8)|(rx_data[1])))/100;
				}
        default:
        {
            break;
...
void CAN_cmd_to_chassis_key(int16_t key_1,
	                      int32_t key_2, int32_t key_3, int16_t key_other )
{
	  uint32_t send_mail_box;
