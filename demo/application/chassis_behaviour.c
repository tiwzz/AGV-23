...
{   
    //遥控器设置行为模式
	  if (chassis_move_mode->chassis_rc_ctrl->key.v&KEY_PRESSED_OFFSET_Z)
    {
        chassis_behaviour_mode = CHASSIS_NO_MOVE;
    }
    else if (chassis_move_mode->chassis_rc_ctrl->key.v&KEY_PRESSED_OFFSET_R)
    {
        chassis_behaviour_mode = CHASSIS_INFANTRY_FOLLOW_GIMBAL_YAW;
    }	
    else if (chassis_move_mode->chassis_rc_ctrl->key.v&KEY_PRESSED_OFFSET_F)
    {
