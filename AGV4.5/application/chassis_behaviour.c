...
{   
   ...
   if (chassis_move_mode->chassis_mode_CANsend==10000)
    {
    ...
    else if (chassis_move_mode->chassis_mode_CANsend==30000)
    {
		...
		else if (chassis_move_mode->chassis_mode_CANsend==20000)
    {
    ...
    {
        chassis_move_mode->chassis_motor_mode = RUDDER_VECTOR_FOLLOW_GIMBAL_YAW; //当行为是舵跟随云台，则设置底盘状态机为 舵跟随云台角度 状态机。
    }		
